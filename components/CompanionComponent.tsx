        ...
        <section className="flex flex-col h-[70vh]">
            <section className="flex gap-8 max-sm:flex-col">
                ...
                <div className="user-section">
                    ...
                    <button className="btn-mic" onClick={toggleMicraphone} disabled={ callStatus != CallStatus.ACTIVE }>
                    ...
                    <button className={cn(
                        'rounded-lg py-2 cursor-pointer transision-colors w-full text-white', 
